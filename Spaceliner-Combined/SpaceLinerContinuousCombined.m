...
throttle1 = 1;
[altdot1,londot1,latdot1,gammadot1,vdot1,azidot1, q1, M1, Fd1, rho1,L1,Fueldt1,T1,Isp1,Isp2,m1,heating_rate1] = SpaceLinerVehicleModel(time1,input.phase(1),throttle1,auxdata,1);
...
throttle2 = 0.891;
[altdot2,londot2,latdot2,gammadot2,vdot2,azidot2, q2, M2, Fd2, rho2,L2,Fueldt2,T2,Isp2,Isp2,m2,heating_rate2] = SpaceLinerVehicleModel(time2,input.phase(2),throttle2,auxdata,1);
...
throttle3 = 0.812;
[altdot3,londot3,latdot3,gammadot3,vdot3,azidot3, q3, M3, Fd3, rho3,L3,Fueldt3,T3,Isp3,Isp3,m3,heating_rate3] = SpaceLinerVehicleModel(time3,input.phase(3),throttle3,auxdata,1);
...
throttle4 = .7333;
[altdot4,londot4,latdot4,gammadot4,vdot4,azidot4, q4, M4, Fd4, rho4,L4,Fueldt4,T4,Isp4,Isp4,m4,heating_rate4] = SpaceLinerVehicleModel(time4,input.phase(4),throttle4,auxdata,1);
...
throttle5 = .6545;
[altdot5,londot5,latdot5,gammadot5,vdot5,azidot5, q5, M5, Fd5, rho5,L5,Fueldt5,T5,Isp5,Isp5,m5,heating_rate5] = SpaceLinerVehicleModel(time5,input.phase(5),throttle5,auxdata,1);
...
throttle6 = .5757;
[altdot6,londot6,latdot6,gammadot6,vdot6,azidot6, q6, M6, Fd6, rho6,L6,Fueldt6,T6,Isp6,Isp6,m6,heating_rate6] = SpaceLinerVehicleModel(time6,input.phase(6),throttle6,auxdata,1);
...
throttle7 = 0.496;
[altdot7,londot7,latdot7,gammadot7,vdot7,azidot7, q7, M7, Fd7, rho7,L7,Fueldt7,T7,Isp7,Isp7,m7,heating_rate7] = SpaceLinerVehicleModel(time7,input.phase(7),throttle7,auxdata,1);
...
throttle8 = 1;
[altdot8,londot8,latdot8,gammadot8,vdot8,azidot8, q8, M8, Fd8, rho8,L8,Fueldt8,T8,Isp8,Isp8,m8,heating_rate8] = SpaceLinerVehicleModel(time8,input.phase(8),throttle8,auxdata,2);
...
[altdot9,londot9,latdot9,gammadot9,vdot9,azidot9, q9, M9, Fd9, rho9,L9,Fueldt9,T9,Isp9,Isp9,m9,heating_rate9] = SpaceLinerVehicleModel(time9,input.phase(9),throttle9,auxdata,3);
