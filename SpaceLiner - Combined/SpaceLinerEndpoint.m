...
t09 = input.phase(9).initialtime;
tf9 = input.phase(9).finaltime;
x09 = input.phase(9).initialstate;
xf9 = input.phase(9).finalstate;

t010 = input.phase(10).initialtime;
tf10 = input.phase(10).finaltime;
x010 = input.phase(10).initialstate;
xf10 = input.phase(10).finalstate;
...
% output.eventgroup(7).event = [x08(1:7)-xf7(1:7) x08(9)-xf7(9) t08-tf7];
output.eventgroup(8).event = [x09-xf8 t09-tf8];
output.eventgroup(9).event = [x010-xf9 t010-tf9];
output.eventgroup(10).event = [tf1-t01,tf2-t02,tf3-t03,tf4-t04,tf5-t05,tf6-t06,tf7-t07,tf8-t08,tf9-t09,tf10-t010];
end
