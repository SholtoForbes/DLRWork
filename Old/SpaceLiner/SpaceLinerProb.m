...
aoaMin = -10*pi/180;  aoaMax = 30*pi/180;
...
bounds.phase(1).state.lower = [0, lonMin, latMin, 0, -deg2rad(50), pi/2, 0, aoaMin];
bounds.phase(1).state.upper = [200000, lonMax, latMax, 15000, deg2rad(85), 3/2*pi, 1.6038e+06, aoaMax];
...
% %FLorida-aus
bounds.phase(1).initialstate.lower = [500,lon0, lat0, 50, deg2rad(86), deg2rad(91), 1.36e+06, aoaMin] ;
bounds.phase(1).initialstate.upper = [550,lon0, lat0, 60, deg2rad(88), deg2rad(269), 1.37e+06, aoaMax];
...
%Test
bounds.phase(8).finalstate.lower = [70000, lonMin, latMin, 6800,deg2rad(-1), deg2rad(200), 0, aoaMin]; % Florida-aus
bounds.phase(8).finalstate.upper = [81000, lonMax, latMax, 7200, deg2rad(1), deg2rad(200),1.6038e+06, aoaMax];
...
guess.phase(1).state(:,2)   = [lon0;lon0-0.01];
guess.phase(1).state(:,3)   = [0.;0.]; %
...
guess.phase(1).state(:,6)   = [deg2rad(180),deg2rad(180)]; %Florida-aus
...
guess.phase(2).state = guess.phase(1).state + [5000 5000; -0.05 -0.05;.0 .0; 1000 1000; -deg2rad(10) -deg2rad(10);0 0;-100000 -100000;0 0]';
guess.phase(3).state = guess.phase(2).state+ [5000 5000; -0.05 -0.05;.0 .0; 1000 1000; -deg2rad(10) -deg2rad(10);0 0;-100000 -100000;0 0]';
guess.phase(4).state = guess.phase(3).state+ [5000 5000; -0.05 -0.05;.0 .0; 1000 1000; -deg2rad(10) -deg2rad(10);0 0;-100000 -100000;0 0]';
guess.phase(5).state = guess.phase(4).state+ [5000 5000; -0.05 -0.05;.0 .0; 1000 1000; -deg2rad(10) -deg2rad(10);0 0;-100000 -100000;0 0]';
guess.phase(6).state = guess.phase(5).state+ [5000 5000; -0.05 -0.05;.0 .0; 1000 1000; -deg2rad(10) -deg2rad(10);0 0;-100000 -100000;0 0]';
guess.phase(7).state = guess.phase(6).state+ [5000 5000; -0.05 -0.05;.0 .0; 1000 1000; -deg2rad(10) -deg2rad(10);0 0;-100000 -100000;0 0]';
guess.phase(8).state = guess.phase(7).state+ [5000 5000; -0.05 -0.05;.0 .0; 1000 1000; -deg2rad(10) -deg2rad(10);0 0;-100000 -100000;0 0]';
