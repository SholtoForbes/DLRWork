...
bounds.phase(1).initialstate.lower = [alt0-1000,0, lat0, v0-100, gamma0-deg2rad(1), zetaMin, aoaMin, bankMin] ;
bounds.phase(1).initialstate.upper = [alt0+1000,0, lat0, v0+500, gamma0+deg2rad(1), zetaMax, aoaMax, bankMax];
...
bounds.phase(1).finalstate.lower = [altFMin, lonF-lon0+2*pi, latF, 100, deg2rad(-20), deg2rad(-65), aoaMin, 0];
bounds.phase(1).finalstate.upper = [altFMax, lonF-lon0+2*pi, latF, 150, deg2rad(20), deg2rad(-65), aoaMax, 0];
...
guess.phase(1).state(:,4)   = [v0+500;vMin];
...
guess.phase(1).state(:,6)   = [deg2rad(90);deg2rad(-60)]; % SLEG
