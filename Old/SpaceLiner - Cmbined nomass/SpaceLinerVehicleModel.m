function [altdot,xidot,phidot,gammadot,a,zetadot, q, M, D, rho,L,mFuel,T,Isp1,Isp2,m,heating_rate,total_acceleration,Cl,Cd] = SpaceLinerVehicleModel(t,phase,throttle,auxdata,stage)
...
mFuel = auxdata.mFuel_init;



for i = 2:length(t)

mFuel(i) = mFuel(i-1)-Fueldt(i-1)*(t(i)-t(i-1));
