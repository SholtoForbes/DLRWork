function [altdot,londot,latdot,gammadot,a,zetadot, q, M, D, rho,L,Fueldt,heating_rate,az] = SpaceLinerVehicleModel(states,controls,auxdata)
...
Cd = auxdata.interp.Stage1.Cd_spline(mach,rad2deg(aoa));
Cl = auxdata.interp.Stage1.Cl_spline(mach,rad2deg(aoa));   
